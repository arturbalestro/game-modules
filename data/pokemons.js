...
var pokemons = [
  ...
  // new Pokemon(185, 'Sudowoodo', rock, spriteUrl+'sudowoodo.png', false, 0, 'Imitation Pokemon', false, [4]),
  // new Pokemon(186, 'Politoed', water, spriteUrl+'politoed.png', false, 0, 'Frog Pokemon', false, [4]),
  // new Pokemon(187, 'Hoppip', grass, spriteUrl+'hoppip.png', true, 0, 'Cottonweed Pokemon', false, [4]),
  // new Pokemon(188, 'Skiploom', grass, spriteUrl+'skiploom.png', true, 0, 'Cottonweed Pokemon', false, [4]),
  // new Pokemon(189, 'Jumpluff', grass, spriteUrl+'jumpluff.png', false, 0, 'Cottonweed Pokemon', false, [4]),
  // new Pokemon(190, 'Aipom', normal, spriteUrl+'aipom.png', false, 0, 'Long Tail Pokemon', false, [4]),
  // new Pokemon(191, 'Sunkern', grass, spriteUrl+'sunkern.png', true, 0, 'Seed Pokemon', false, [4]),
  // new Pokemon(192, 'Sunflora', grass, spriteUrl+'sunflora.png', false, 0, 'Sun Pokemon', false, [4]),
  // new Pokemon(193, 'Yanma', bug, spriteUrl+'yanma.png', false, 0, 'Clear Wing Pokemon', false, [4]),
  // new Pokemon(194, 'Wooper', water, spriteUrl+'wooper.png', true, 0, 'Water Fish Pokemon', false, [4]),
  // new Pokemon(195, 'Quagsire', water, spriteUrl+'quagsire.png', false, 0, 'Water Fish Pokemon', false, [4]),
  // new Pokemon(196, 'Espeon', psychic, spriteUrl+'espeon.png', false, 0, 'Sun Pokemon', false, [4]),
  // new Pokemon(197, 'Umbreon', dark, spriteUrl+'umbreon.png', false, 0, 'Moonlight Pokemon', false, [4]),
  // new Pokemon(198, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(199, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(200, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(201, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(202, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(203, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(204, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(205, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(206, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(207, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(208, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(209, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(210, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),

  // new Pokemon(211, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(212, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(213, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(214, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(215, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(216, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(217, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(218, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(220, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(221, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(222, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(223, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(224, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(225, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(226, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),

  // new Pokemon(227, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(228, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(229, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(230, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(231, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(232, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(233, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(234, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(235, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(236, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(237, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(238, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(238, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(240, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),

  // new Pokemon(241, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(242, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(243, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(244, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(245, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(246, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(247, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(248, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(249, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(250, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(251, 'Celebi', psychic, spriteUrl+'celebi.png', false, 0, ' Pokemon', false, [4]),

  // new Pokemon(252, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
]
