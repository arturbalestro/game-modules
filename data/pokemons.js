...
var pokemons = [
  ...
  // new Pokemon(153, 'Bayleef', grass, spriteUrl+'bayleef.png', true, 0, 'Leaf Pokemon', false, [1, 4]),
  // new Pokemon(154, 'Meganium', grass, spriteUrl+'meganium.png', false, 0, 'Herb Pokemon', false, [4]),
  // new Pokemon(155, 'Cyndaquil', fire, spriteUrl+'cyndaquil.png', true, 0, 'Fire Mouse Pokemon', false, [0, 1, 4, 5, 6]),
  // new Pokemon(156, 'Quilava', fire, spriteUrl+'quilava.png', true, 0, 'Volcano Pokemon', false, [4]),
  // new Pokemon(157, 'Typhlosion', fire, spriteUrl+'typhlosion.png', false, 0, 'Volcano Pokemon', false, [4]),
  // new Pokemon(158, 'Totodile', water, spriteUrl+'totodile.png', true, 0, 'Big Jaw Pokemon', false, [0, 1, 4, 5, 6]),
  // new Pokemon(159, 'Croconaw', water, spriteUrl+'croconaw.png', true, 0, 'Big Jaw Pokemon', false, [4]),
  // new Pokemon(160, 'Feraligatr', water, spriteUrl+'feraligatr.png', false, 0, 'Big Jaw Pokemon', false, [4]),
  // new Pokemon(161, 'Sentret', normal, spriteUrl+'sentret.png', true, 0, 'Scout Pokemon', false, [0, 4, 5]),
  // new Pokemon(162, 'Furret', normal, spriteUrl+'furret.png', false, 0, 'Long Body Pokemon', false, [4]),
  // new Pokemon(163, 'Hoothoot', flying, spriteUrl+'hoothoot.png', true, 0, 'Owl Pokemon', false, [0, 4, 5]),
  // new Pokemon(164, 'Noctowl', flying, spriteUrl+'noctowl.png', false, 0, 'Owl Pokemon', false, [1, 4]),
  // new Pokemon(165, 'Ledyba', bug, spriteUrl+'ledyba.png', true, 0, 'Five Star Pokemon', false, [0, 4, 5]),
  // new Pokemon(166, 'Ledian', bug, spriteUrl+'ledian.png', false, 0, 'Five Star Pokemon', false, [4]),
  // new Pokemon(167, 'Spinarak', bug, spriteUrl+'spinarak.png', true, 0, 'String Spit Pokemon', false, [0, 4, 5]),
  // new Pokemon(168, 'Ariados', bug, spriteUrl+'ariados.png', false, 0, 'Long Leg Pokemon', false, [4]),
  // new Pokemon(169, 'Crobat', poison, spriteUrl+'crobat.png', false, 0, 'Bat Pokemon', false, [4]),
  // new Pokemon(170, 'Chinchou', electric, spriteUrl+'chinchou.png', true, 0, 'Angler Pokemon', false, [0, 4, 5]),
  // new Pokemon(171, 'Lanturn', electric, spriteUrl+'lanturn.png', false, 0, 'Light Pokemon', false, [4]),
  // new Pokemon(172, 'Pichu', electric, spriteUrl+'pichu.png', false, 0, 'Tiny Mouse Pokemon', false, [0, 4]),
  // new Pokemon(173, 'Cleffa', fairy, spriteUrl+'cleffa.png', false, 0, 'Star Shape Pokemon', false, [0, 4, 5]),
  // new Pokemon(174, 'Igglybuff', fairy, spriteUrl+'igglybuff.png', false, 0, 'Balloon Pokemon', false, [0, 4, 5]),
  // new Pokemon(175, 'Togepi', fairy, spriteUrl+'togepi.png', true, 0, 'Spike Ball Pokemon', false, [0, 4, 5]),
  // new Pokemon(176, 'Togetic', fairy, spriteUrl+'togetic.png', false, 0, 'Happiness Pokemon', false, [4]),
  // new Pokemon(177, 'Natu', psychic, spriteUrl+'natu.png', true, 0, 'Tiny Bird Pokemon', false, [0, 4, 5]),
  // new Pokemon(178, 'Xatu', psychic, spriteUrl+'xatu.png', false, 0, 'Mystic Pokemon', false, [4]),

  // new Pokemon(179, 'Mareep', electric, spriteUrl+'mareep.png', true, 0, 'Wool Pokemon', false, [0, 4, 5]),
  // new Pokemon(180, 'Flaaffy', electric, spriteUrl+'flaaffy.png', true, 0, 'Wool Pokemon', false, [4]),
  // new Pokemon(181, 'Ampharos', electric, spriteUrl+'ampharos.png', false, 0, 'Light Pokemon', false, [4]),
  // new Pokemon(182, 'Bellossom', grass, spriteUrl+'bellossom.png', false, 0, 'Flower Pokemon', false, [0, 4, 5]),
  // new Pokemon(183, 'Marill', water, spriteUrl+'marill.png', true, 0, 'Aqua Mouse Pokemon', false, [4]),
  // new Pokemon(184, 'Azumarill', water, spriteUrl+'azumarill.png', false, 0, 'Aqua Rabbit Pokemon', false, [4]),
  // new Pokemon(185, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(186, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
  // new Pokemon(179, '', , spriteUrl+'.png', false, 0, ' Pokemon', false, [4]),
]
